...
var require_ssr = __commonJS({
  "ssr.js"(exports, module) {
    ...
    const Mt = vue_cjs_prod.ref(0), ie = vue_cjs_prod.ref(1), R = vue_cjs_prod.ref({}), ae = vue_cjs_prod.ref(0), zt = vue_cjs_prod.ref({}), tt = {}, $e = typeof window > "u";
    function fo(e, t, r) {
    ...
    const ur = vue_cjs_prod.ref(0), Nr = vue_cjs_prod.ref(null);
    function vo(e) {
    ...
    const wi = vue_cjs_prod.ref({}), Si = (e) => wi.value[e], bo = (e) => Object.keys(Si.value[e]).length > 0, Oi = vue_cjs_prod.ref({}), wo = (e) => Oi.value[e], $i = vue_cjs_prod.ref({}), So = (e) => $i.value[e], rt = vue_cjs_prod.ref([]);
    function Oo(e) {
      rt.value.push(e);
    }
    const $o = vue_cjs_prod.computed(() => co(rt.value));
    function Eo(e) {
      rt.value[e].dismissed = true, rt.value[e].html = null;
    }
    const Vr = vue_cjs_prod.ref(null);
    ...
    const p = {
      ...
      // ref
      stackType: _o,
      pageVisitId: vue_cjs_prod.computed(() => R.value.pageVisitId),
      // ref
      dynamicVisitId: vue_cjs_prod.computed(() => R.value.dynamicVisitId),
      // ref
      isSsr: $e,
    ...
    const ue = {
      ...
      setup(e) {
        const t = e, r = vue_cjs_prod.ref(null);
        function n() {
          r.value = vue_cjs_prod.h({
            template: t.html,
            data() {
        ...
        return vue_cjs_prod.watch(() => t.html, n, { immediate: true }), (i, s) => e.html ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.unref(r), { key: 0 })) : vue_cjs_prod.createCommentVNode("", true);
      }
    }, Vo = {
      __name: "ServerError",
      props: {
      ...
      emits: ["close"],
      setup(e, { emit: t }) {
        const r = e, n = vue_cjs_prod.ref(null);
        function i() {
        ...
        return vue_cjs_prod.onMounted(() => i()), (o, l) => (vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("div", {
          style: { position: "fixed", top: "0px", right: "0px", bottom: "0px", left: "0px", "z-index": "200000", "box-sizing": "border-box", height: "100vh", width: "100vw", "background-color": "rgb(0 0 0 / 0.75)", padding: "2rem" },
          onClick: a
        }, [
          vue_cjs_prod.createElementVNode("iframe", {
      ...
      setup(e) {
        const t = e;
        vue_cjs_prod.provide("stack", 0);
        const r = vue_cjs_prod.ref(), n = vue_cjs_prod.ref([]), i = vue_cjs_prod.ref(null), s = vue_cjs_prod.ref(null), a = vue_cjs_prod.ref(true), o = vue_cjs_prod.inject("$spladeOptions") || {}, l = vue_cjs_prod.computed(() => p.currentStack.value < 1 ? [] : {
          filter: "blur(4px)",
        ...
        const f = (h, m) => {
          n.value = [], r.value = h, vue_cjs_prod.nextTick(() => {
            if (!p.isSsr) {
        ...
        return p.setOnHtml((h, m, d) => {
          ...
          n.value[p.currentStack.value] && (a.value = false), n.value[p.currentStack.value] = { html: h, type: m }, vue_cjs_prod.nextTick(() => {
            a.value = true;
          });
        }), p.setOnServerError(function(h) {
          i.value = h;
        }), p.init(t.initialHtml, t.initialDynamics, t.initialSpladeData), vue_cjs_prod.onMounted(() => {
          if (p.isSsr)
            return;
        ...
        }), (h, m) => (vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("div", null, [
          vue_cjs_prod.unref(p).isSsr ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(ue, {
            key: `visit.${vue_cjs_prod.unref(p).pageVisitId.value}`,
            style: vue_cjs_prod.normalizeStyle(l.value),
            html: r.value
          }, null, 8, ["style", "html"])) : (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.KeepAlive, {
            key: 0,
            max: vue_cjs_prod.unref(o).max_keep_alive
          }, [
            (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(ue, {
              key: `visit.${vue_cjs_prod.unref(p).pageVisitId.value}`,
              style: vue_cjs_prod.normalizeStyle(l.value),
              html: r.value
            }, null, 8, ["style", "html"]))
          ], 1032, ["max"])),
          vue_cjs_prod.createVNode(ue, { html: e.components }, null, 8, ["html"]),
          (vue_cjs_prod.openBlock(true), vue_cjs_prod.createElementBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(vue_cjs_prod.unref(p).currentStack.value, (d) => (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(ue, {
            key: `modal.${d}`,
            type: n.value[d].type,
            html: n.value[d].html,
            stack: d,
            "on-top-of-stack": vue_cjs_prod.unref(p).currentStack.value === d,
            animate: a.value,
            onClose: (b) => c(d)
          }, null, 8, ["type", "html", "stack", "on-top-of-stack", "animate", "onClose"]))), 128)),
          i.value ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(Vo, {
            key: 2,
            html: i.value,
            onClose: u
          }, null, 8, ["html"])) : vue_cjs_prod.createCommentVNode("", true)
        ]));
      }
    };
    function Cp(e) {
      return () => vue_cjs_prod.h(Ho, e);
    }
...
`)].join(`
`));
          let f = Ri((a = v.props) != null ? a : {}, l), h = vue_cjs_prod.cloneVNode(v, f);
          for (let m in f)
      ...
      return vue_cjs_prod.h(o, Object.assign({}, l, c), { default: () => u });
    }
    function Li(e) {
      return e.flatMap((t) => t.type === vue_cjs_prod.Fragment ? Li(t.children) : [t]);
    }
    function Ri(...e) {
      if (e.length === 0)
        return {};
    ...
    function Zr() {
      return vue_cjs_prod.inject(Mi, null);
    }
    function Kl(e) {
      vue_cjs_prod.provide(Mi, e);
    }
    ...
    function fr(e, t, r) {
      Et.isServer || vue_cjs_prod.watchEffect((n) => {
        document.addEventListener(e, t, r), n(() => document.removeEventListener(e, t, r));
      });
    }
    function au(e, t, r = vue_cjs_prod.computed(() => true)) {
      function n(s, a) {
    ...
    let wr = vue_cjs_prod.defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(e, { slots: t, attrs: r }) {
      return () => {
    ...
    function uu() {
      let e = vue_cjs_prod.ref(0);
      return lu("keydown", (t) => {
        t.key === "Tab" && (e.value = t.shiftKey ? 1 : 0);
      }), e;
    }
    function Vi(e, t, r, n) {
      Et.isServer || vue_cjs_prod.watchEffect((i) => {
    ...
    let pt = Object.assign(vue_cjs_prod.defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: vue_cjs_prod.ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
      let i = vue_cjs_prod.ref(null);
      n({ el: i, $el: i });
      let s = vue_cjs_prod.computed(() => Tt(i)), a = vue_cjs_prod.ref(false);
      vue_cjs_prod.onMounted(() => a.value = true), vue_cjs_prod.onUnmounted(() => a.value = false), fu({ ownerDocument: s }, vue_cjs_prod.computed(() => a.value && !!(e.features & 16)));
      let o = pu({ ownerDocument: s, container: i, initialFocus: vue_cjs_prod.computed(() => e.initialFocus) }, vue_cjs_prod.computed(() => a.value && !!(e.features & 2)));
      hu({ ownerDocument: s, container: i, containers: e.containers, previousActiveElement: o }, vue_cjs_prod.computed(() => a.value && !!(e.features & 8)));
      let l = uu();
      function u(f) {
        let h = D(i);
        h && ((m) => m())(() => {
      ...
      return () => {
        ...
        return vue_cjs_prod.h(vue_cjs_prod.Fragment, [!!(m & 4) && vue_cjs_prod.h(wr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Nt.Focusable }), Z({ ourProps: h, theirProps: { ...t, ...O }, slot: f, attrs: t, slots: r, name: "FocusTrap" }), !!(m & 4) && vue_cjs_prod.h(wr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Nt.Focusable })]);
      };
    } }), { features: Wi }), He = [];
    cu(() => {
      function e(t) {
    ...
    function du(e) {
      let t = vue_cjs_prod.ref(He.slice());
      return vue_cjs_prod.watch([e], ([r], [n]) => {
        n === true && r === false ? Hi(() => {
          t.value.splice(0);
    ...
    function pu({ ownerDocument: e, container: t, initialFocus: r }, n) {
      let i = vue_cjs_prod.ref(null), s = vue_cjs_prod.ref(false);
      return vue_cjs_prod.onMounted(() => s.value = true), vue_cjs_prod.onUnmounted(() => s.value = false), vue_cjs_prod.onMounted(() => {
        vue_cjs_prod.watch([t, r, n], (a, o) => {
    ...
    function Fn(e, t = vue_cjs_prod.ref(true)) {
      vue_cjs_prod.watchEffect((r) => {
        var n;
        if (!t.value)
          return;
        let i = D(e);
    ...
    function mu() {
      return vue_cjs_prod.inject(Gi, false);
    }
    let Sr = vue_cjs_prod.defineComponent({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: false } }, setup(e, { slots: t, attrs: r }) {
      return vue_cjs_prod.provide(Gi, e.force), () => {
        let { force: n, ...i } = e;
    ...
    let Xi = vue_cjs_prod.defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
      let n = vue_cjs_prod.ref(null), i = vue_cjs_prod.computed(() => Tt(n)), s = mu(), a = vue_cjs_prod.inject(Ki, null), o = vue_cjs_prod.ref(s === true || a == null ? vu(n.value) : a.resolveTarget());
      return vue_cjs_prod.watchEffect(() => {
        ...
        return vue_cjs_prod.h(vue_cjs_prod.Teleport, { to: o.value }, Z({ ourProps: l, theirProps: e, slot: {}, attrs: r, slots: t, name: "Portal" }));
      };
    } }), Ki = Symbol("PortalGroupContext"), gu = vue_cjs_prod.defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
      let n = vue_cjs_prod.reactive({ resolveTarget() {
        return e.target;
      } });
      return vue_cjs_prod.provide(Ki, n), () => {
        let { target: i, ...s } = e;
    ...
    function bu({ type: e, enabled: t, element: r, onUpdate: n }) {
      ...
      vue_cjs_prod.onMounted(() => {
        vue_cjs_prod.watch(t, (a, o) => {
          a ? s(0, e, r) : o === true && s(1, e, r);
        }, { immediate: true, flush: "sync" });
      }), vue_cjs_prod.onUnmounted(() => {
        t.value && s(1, e, r);
      }), vue_cjs_prod.provide(Ji, s);
    }
    let Qi = Symbol("DescriptionContext");
    function wu() {
      let e = vue_cjs_prod.inject(Qi, null);
      if (e === null)
        throw new Error("Missing parent");
      return e;
    }
    function Su({ slot: e = vue_cjs_prod.ref({}), name: t = "Description", props: r = {} } = {}) {
      let n = vue_cjs_prod.ref([]);
      function i(s) {
      ...
      return vue_cjs_prod.provide(Qi, { register: i, slot: e, name: t, props: r }), vue_cjs_prod.computed(() => n.value.length > 0 ? n.value.join(" ") : void 0);
    }
    vue_cjs_prod.defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${Ye()}` } }, setup(e, { attrs: t, slots: r }) {
      let n = wu();
      return vue_cjs_prod.onMounted(() => vue_cjs_prod.onUnmounted(n.register(e.id))), () => {
        let { name: i = "Description", slot: s = vue_cjs_prod.ref({}), props: a = {} } = n, { id: o, ...l } = e, u = { ...Object.entries(a).reduce((c, [v, g]) => Object.assign(c, { [v]: vue_cjs_prod.unref(g) }), {}), id: o };
        return Z({ ourProps: u, theirProps: l, slot: s.value, attrs: t, slots: r, name: i });
      };
    } });
    function Ou(e) {
      let t = vue_cjs_prod.shallowRef(e.getSnapshot());
      return vue_cjs_prod.onUnmounted(e.subscribe(() => {
    ...
    function Iu(e, t, r) {
      let n = Ou(Ue), i = vue_cjs_prod.computed(() => {
        let s = e.value ? n.value.get(e.value) : void 0;
        return s ? s.count > 0 : false;
      });
      return vue_cjs_prod.watch([e, t], ([s, a], [o], l) => {
        if (!s || !a)
          return;
    ...
    function xt(e) {
      let t = vue_cjs_prod.inject($r, null);
      if (t === null) {
    ...
    let qt = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", en = vue_cjs_prod.defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: qt }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Ye()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
      var s;
      let a = vue_cjs_prod.ref(false);
      vue_cjs_prod.onMounted(() => {
        a.value = true;
      });
      let o = vue_cjs_prod.ref(0), l = Zr(), u = vue_cjs_prod.computed(() => e.open === qt && l !== null ? (l.value & G.Open) === G.Open : e.open), c = vue_cjs_prod.ref(null), v = vue_cjs_prod.ref(null), g = vue_cjs_prod.computed(() => Tt(c));
      ...
      let f = vue_cjs_prod.computed(() => a.value && u.value ? 0 : 1), h = vue_cjs_prod.computed(() => f.value === 0), m = vue_cjs_prod.computed(() => o.value > 1), d = vue_cjs_prod.inject($r, null) !== null, b = vue_cjs_prod.computed(() => m.value ? "parent" : "leaf"), O = vue_cjs_prod.computed(() => l !== null ? (l.value & G.Closing) === G.Closing : false), A = vue_cjs_prod.computed(() => d || O.value ? false : h.value), S = vue_cjs_prod.computed(() => {
        var E, T, I;
      ...
      Fn(S, A);
      let $ = vue_cjs_prod.computed(() => m.value ? true : h.value), w = vue_cjs_prod.computed(() => {
        var E, T, I;
      ...
      Fn(w, $), bu({ type: "Dialog", enabled: vue_cjs_prod.computed(() => f.value === 0), element: c, onUpdate: (E, T) => {
        if (T === "Dialog")
          return fe(E, { [Or.Add]: () => o.value += 1, [Or.Remove]: () => o.value -= 1 });
      } });
      let _ = Su({ name: "DialogDescription", slot: vue_cjs_prod.computed(() => ({ open: u.value })) }), q = vue_cjs_prod.ref(null), P = { titleId: q, panelRef: vue_cjs_prod.ref(null), dialogState: f, setTitleId(E) {
        q.value !== E && (q.value = E);
      }, close() {
        t("close", false);
      } };
      vue_cjs_prod.provide($r, P);
      function k() {
        var E, T, I;
      ...
      let j = vue_cjs_prod.computed(() => !(!h.value || m.value));
      au(() => k(), (E, T) => {
        P.close(), vue_cjs_prod.nextTick(() => T == null ? void 0 : T.focus());
      }, j);
      let H = vue_cjs_prod.computed(() => !(m.value || f.value !== 0));
      ...
      let F = vue_cjs_prod.computed(() => !(O.value || f.value !== 0 || d));
      return Iu(g, F, (E) => {
        var T;
        return { containers: [...(T = E.containers) != null ? T : [], k] };
      }), vue_cjs_prod.watchEffect((E) => {
        if (f.value !== 0)
          return;
        let T = D(c);
        if (!T)
        ...
        return vue_cjs_prod.h(Sr, { force: true }, () => [vue_cjs_prod.h(Xi, () => vue_cjs_prod.h(gu, { target: c.value }, () => vue_cjs_prod.h(Sr, { force: false }, () => vue_cjs_prod.h(pt, { initialFocus: I, containers: k, features: h.value ? fe(b.value, { parent: pt.features.RestoreFocus, leaf: pt.features.All & ~pt.features.FocusLock }) : pt.features.None }, () => Z({ ourProps: ge, theirProps: C, slot: U, attrs: r, slots: n, visible: f.value === 0, features: Dt.RenderStrategy | Dt.Static, name: "Dialog" }))))), vue_cjs_prod.h(wr, { features: Nt.Hidden, ref: v })]);
      };
    } });
    vue_cjs_prod.defineComponent({ name: "DialogOverlay", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-overlay-${Ye()}` } }, setup(e, { attrs: t, slots: r }) {
    ...
    vue_cjs_prod.defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${Ye()}` } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
      let i = xt("DialogBackdrop"), s = vue_cjs_prod.ref(null);
      return n({ el: s, $el: s }), vue_cjs_prod.onMounted(() => {
        if (i.panelRef.value === null)
          throw new Error("A <DialogBackdrop /> component is being used, but a <DialogPanel /> component is missing.");
      }), () => {
        let { id: a, ...o } = e, l = { id: a, ref: s, "aria-hidden": true };
        return vue_cjs_prod.h(Sr, { force: true }, () => vue_cjs_prod.h(Xi, () => Z({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
      };
    } });
    let tn = vue_cjs_prod.defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${Ye()}` } }, setup(e, { attrs: t, slots: r, expose: n }) {
    ...
    vue_cjs_prod.defineComponent({ name: "DialogTitle", props: { as: { type: [Object, String], default: "h2" }, id: { type: String, default: () => `headlessui-dialog-title-${Ye()}` } }, setup(e, { attrs: t, slots: r }) {
      let n = xt("DialogTitle");
      return vue_cjs_prod.onMounted(() => {
        n.setTitleId(e.id), vue_cjs_prod.onUnmounted(() => n.setTitleId(null));
      }), () => {
        let { id: i, ...s } = e;
    ...
    function Fu() {
      return vue_cjs_prod.inject(rn, null) !== null;
    }
    function ku() {
      let e = vue_cjs_prod.inject(rn, null);
      if (e === null)
        throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
      return e;
    }
    function Lu() {
      let e = vue_cjs_prod.inject(nn, null);
      if (e === null)
        throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
      return e;
    }
    ...
    function Yi(e) {
      let t = vue_cjs_prod.ref([]), r = vue_cjs_prod.ref(false);
      vue_cjs_prod.onMounted(() => r.value = true), vue_cjs_prod.onUnmounted(() => r.value = false);
    ...
    let Zi = Dt.RenderStrategy, lt = vue_cjs_prod.defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
      ...
      if (!Fu() && Xl())
        return () => vue_cjs_prod.h(ut, { ...e, onBeforeEnter: a, onAfterEnter: o, onBeforeLeave: l, onAfterLeave: u }, n);
      let c = vue_cjs_prod.ref(null), v = vue_cjs_prod.computed(() => e.unmount ? Ce.Unmount : Ce.Hidden);
      i({ el: c, $el: c });
      let { show: g, appear: f } = ku(), { register: h, unregister: m } = Lu(), d = vue_cjs_prod.ref(g.value ? "visible" : "hidden"), b = { value: true }, O = Ye(), A = { value: false }, S = Yi(() => {
      ...
      return vue_cjs_prod.onMounted(() => {
        vue_cjs_prod.watch([g], (F, E, T) => {
          H(T), b.value = false;
        }, { immediate: true });
      }), vue_cjs_prod.provide(nn, S), Kl(vue_cjs_prod.computed(() => fe(d.value, { visible: G.Open, hidden: G.Closed }) | s.value)), () => {
        let { appear: F, show: E, enter: T, enterFrom: I, enterTo: C, entered: ge, leave: U, leaveFrom: ct, leaveTo: It, ...Ie } = e, Ze = { ref: c }, Ae = { ...Ie, ...f.value && g.value && Et.isServer ? { class: vue_cjs_prod.normalizeClass([r.class, Ie.class, ...$, ...w]) } : {} };
        return Z({ theirProps: Ae, ourProps: Ze, slot: {}, slots: n, attrs: r, features: Zi, visible: d.value === "visible", name: "TransitionChild" });
      };
    } }), Ru = lt, ut = vue_cjs_prod.defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n }) {
      let i = Zr(), s = vue_cjs_prod.computed(() => e.show === null && i !== null ? (i.value & G.Open) === G.Open : e.show);
      vue_cjs_prod.watchEffect(() => {
        if (![true, false].includes(s.value))
          throw new Error('A <Transition /> is used but it is missing a `:show="true | false"` prop.');
      });
      let a = vue_cjs_prod.ref(s.value ? "visible" : "hidden"), o = Yi(() => {
        a.value = "hidden";
      }), l = vue_cjs_prod.ref(true), u = { show: s, appear: vue_cjs_prod.computed(() => e.appear || !l.value) };
      return vue_cjs_prod.onMounted(() => {
        vue_cjs_prod.watchEffect(() => {
          l.value = false, s.value ? a.value = "visible" : Zt(o) || (a.value = "hidden");
        });
      }), vue_cjs_prod.provide(nn, o), vue_cjs_prod.provide(rn, u), () => {
        let c = Bi(e, ["show", "appear", "unmount", "onBeforeEnter", "onBeforeLeave", "onAfterEnter", "onAfterLeave"]), v = { unmount: e.unmount };
        return Z({ ourProps: { ...v, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [vue_cjs_prod.h(Ru, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...v, ...c }, n.default)] }, attrs: {}, features: Zi, visible: a.value === "visible", name: "Transition" });
      };
    } });
    const Bu = {
      props: {
    ...
    const nc = {
      ...
      setup(e) {
        const t = e, r = vue_cjs_prod.ref(null), n = vue_cjs_prod.ref(null), i = vue_cjs_prod.ref(null);
        return vue_cjs_prod.onMounted(() => {
          r.value = (s) => {
        ...
        }), (s, a) => (vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("div", {
          ref_key: "root",
          ref: n
        }, [
          vue_cjs_prod.renderSlot(s.$slots, "default")
        ], 512));
      }
    };
    function Q(e) {
    ...
    const sd = {
      ...
      mounted: async function() {
        this.teleport && await vue_cjs_prod.nextTick();
    ...
    function ld(e, t, r, n, i, s) {
      const a = vue_cjs_prod.resolveComponent("OnClickOutside");
      return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(a, {
        style: vue_cjs_prod.normalizeStyle(s.wrapperStyle),
        do: s.hide,
        opened: i.opened,
        ...
        default: vue_cjs_prod.withCtx(() => [
          vue_cjs_prod.createElementVNode("div", {
            ref: "button",
            style: vue_cjs_prod.normalizeStyle(s.buttonStyle)
          }, [
            vue_cjs_prod.renderSlot(e.$slots, "button", {
              toggle: s.toggle,
              disabled: r.disabled
            })
          ], 4),
          vue_cjs_prod.createElementVNode("div", od, [
            vue_cjs_prod.renderSlot(e.$slots, "default", {
              hide: s.hide,
              opened: i.opened
            })
          ], 512)
    ...
    const ud = /* @__PURE__ */ _e(ad, [["render", ld]]), cd = {
      ...
      setup(e) {
        const t = vue_cjs_prod.inject("$splade") || {}, r = vue_cjs_prod.inject("$spladeOptions") || {};
        return (n, i) => vue_cjs_prod.unref(t).isSsr ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(ue, {
          key: e.keepAliveKey,
          html: vue_cjs_prod.unref(t).htmlForDynamicComponent(e.name),
          passthrough: e.passthrough
        }, null, 8, ["html", "passthrough"])) : (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.KeepAlive, {
          key: 0,
          max: vue_cjs_prod.unref(r).max_keep_alive
        }, [
          (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(ue, {
            key: e.keepAliveKey,
            html: vue_cjs_prod.unref(t).htmlForDynamicComponent(e.name),
    ...
    function Rf(e, t, r, n, i, s) {
      return vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("div", Lf, [
        vue_cjs_prod.renderSlot(e.$slots, "default", {
...
`));
    ...
    function Hf(e, t, r, n, i, s) {
      return vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("div", Vf, [
        vue_cjs_prod.renderSlot(e.$slots, "default", { disabled: i.disabled })
      ], 512);
    }
    ...
    function Gf(e, t, r, n, i, s) {
      return vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("div", zf, [
        vue_cjs_prod.renderSlot(e.$slots, "default")
      ], 512);
    }
    ...
    function Jf(e, t, r, n, i, s) {
      const a = vue_cjs_prod.resolveComponent("Render");
      return i.html ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(a, {
        key: 0,
        html: i.html,
        passthrough: r.passthrough
      }, null, 8, ["html", "passthrough"])) : r.show ? vue_cjs_prod.renderSlot(e.$slots, "default", { key: 1 }) : vue_cjs_prod.createCommentVNode("", true);
    }
    const Qf = /* @__PURE__ */ _e(Kf, [["render", Jf]]), Yf = ["href", "onClick"], Zf = {
      ...
      setup(e) {
        const t = e, r = vue_cjs_prod.inject("stack"), n = vue_cjs_prod.ref(null);
        function i() {
        ...
        return (a, o) => (vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("a", {
          href: e.href,
          onClick: vue_cjs_prod.withModifiers(i, ["exact", "prevent"])
        }, [
          vue_cjs_prod.renderSlot(a.$slots, "default")
        ], 8, Yf));
      }
    }, ep = {
      provide() {
    ...
    function np(e, t, r, n, i, s) {
      ...
      return i.html ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(a, {
        ...
        html: i.html,
        passthrough: r.passthrough
      }, null, 8, ["html", "passthrough"])) : i.loading ? vue_cjs_prod.renderSlot(e.$slots, "placeholder", { key: 1 }) : vue_cjs_prod.renderSlot(e.$slots, "default", { key: 2 });
    }
    ...
    function up(e, t, r, n, i, s) {
      return vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("div", lp, [
        vue_cjs_prod.renderSlot(e.$slots, "default", { loading: i.loading })
      ], 512);
    }
...
`));
    ...
    const mp = {
      ...
      methods: {
         ...
         */
        showSearchInput(e) {
          this.forcedVisibleSearchInputs = [...this.forcedVisibleSearchInputs, e], vue_cjs_prod.nextTick(() => {
        ...
        visitWithQueryObject(e, t, r) {
          ...
          p.replace(s, o).then(() => {
            this.isLoading = false, typeof t < "u" && t && vue_cjs_prod.nextTick(() => {
      ...
      data() {
        return {
          isMounted: false,
          Teleport: vue_cjs_prod.Teleport
        };
      },
      /*
    ...
    function gp(e, t, r, n, i, s) {
      return vue_cjs_prod.withDirectives((vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(vue_cjs_prod.resolveDynamicComponent(i.isMounted ? i.Teleport : "div"), vue_cjs_prod.normalizeProps(vue_cjs_prod.guardReactiveProps(e.$attrs)), {
        default: vue_cjs_prod.withCtx(() => [
          vue_cjs_prod.renderSlot(e.$slots, "default")
        ]),
        _: 3
      }, 16)), [
        [vue_cjs_prod.vShow, i.isMounted]
      ]);
    }
      ...
      watch: {
        modelValue() {
          !this.autosize || !this.autosizeInstance || import("autosize").then((e) => {
            vue_cjs_prod.nextTick(() => e.default.update(this.element));
          });
        }
      },
      mounted() {
    ...
    function Sp(e, t, r, n, i, s) {
      return vue_cjs_prod.openBlock(), vue_cjs_prod.createElementBlock("div", wp, [
        vue_cjs_prod.renderSlot(e.$slots, "default")
      ], 512);
    }
  ...
  `, document.head.appendChild(t);
    ...
    kp(createServer, renderToString, (props) => {
      return vue_cjs_prod.createSSRApp({
        render: Cp(props)
      }).use(Fp);
    });
  }
